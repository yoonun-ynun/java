...
public interface List<E> {
    ...
    /*
    리스트에 요소를 추가합니다.
    @param value 리스트에 추가할 요요
    @return 리스트에서 중복을 허용하지 않을 경우에 이미 중복되는 요소가 있을경우
    @code false를 반환하고 중복되는 원소가 없을경우 @code true를 반환
     */
    ...
    /*
    리스트에서 특정 요소를 삭제합니다. 동일한 요소가 여러 개일 경우
    가장 처음 발견한 요소만 삭제됩니다.

    @param value 리스트에서 삭제할 요소
    @return 리스트에 삭제할 요소가 없거나 삭제에 실패할 경우
    @code false를 반환하고 성공할 경우 @code true를 반환
     */
    E get(int index);
    /*
    ...
    /*
    리스트에 특정 위치에 있는 요소를 새 요소로 대체합니다.
    ...
    /*
    리스트에 특정 요소가 몇 번쨰 위치에 있는지를 반환합니다.
